    ...
    <div class="container">
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-home " >
                        <a href="pindex.php" class="non-style-link-menu "><div><p class="menu-text">Home</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="pdoctor.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Doctors</p></a></div>
                    </td>
                </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="pdoctor.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
...
?>
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                $sqlmain = "SELECT * FROM doctor ORDER BY docid DESC"; // Default query to fetch all doctors
                                if ($_POST) {
                                    $keyword = $_POST["search"];
                                    // Update the query to search by doctor name or email
                                    $sqlmain = "SELECT * FROM doctor WHERE docemail = '$keyword' OR docname = '$keyword' OR docname LIKE '$keyword%' OR docname LIKE '%$keyword' OR docname LIKE '%$keyword%'";
                                }
            ...
            <td>' . substr($specialities , 0, 20) . '</td>
            <td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="pdoctor.php">&times;</a>
                        <div class="content">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="pdoctor.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to pdoctor sessions?</h2>
                        <a class="close" href="pdoctor.php">&times;</a>
                        <div class="content">
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a href="pdoctor.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
